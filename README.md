...
**How to play:**
1. **Start the server:** Run the `server.py <host> <port>` script. 
2. **Connect clients:** Run the `client.py <host> <port> <username>` script on two different machines or terminals.
